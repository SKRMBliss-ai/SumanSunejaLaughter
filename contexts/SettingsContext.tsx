...
export interface ThemeColors {
    ...
    // --- NEW: Session Card Styling ---
    SESSION_1_BG: string;      // Daily Session Decoration BG
    SESSION_1_ACCENT: string;  // Daily Session Icon/Text Color
    SESSION_2_BG: string;      // Traditional Session Decoration BG
    SESSION_2_ACCENT: string;  // Traditional Session Icon/Text Color
}

export const THEMES: Record<ColorTheme, ThemeColors> = {
    pastel: {
        // Updated Pastel Theme (Purple/Teal - Matches image_c35c5c.jpg)
    ...
    red_brick: {
        // Brand Color Aesthetic (Red/Cream) - Matches image_c43995.png
        ...
        // Fun Games: Solid Red (matches image_c43995.png)
        GAMES: "bg-[#8B3A3A] text-white border-2 border-[#8B3A3A] hover:brightness-110 transition-colors",
        GAMES_ICON_BG: "bg-white/20 text-white p-3 rounded-full mb-1",

        // Book Session: Cream with Red Border (matches image_c43995.png)
