...
export const AmbientMusic: React.FC = () => {
  ...
  return (
    <div className={`fixed bottom-24 right-4 z-40 flex flex-col items-end gap-2 transition-all duration-500 ${isPlaying ? 'translate-x-0' : 'translate-x-2'}`}>
        ...
        <div className="flex items-center gap-2 group">
            ...
            <button 
                ...
                className={`w-12 h-12 rounded-full flex items-center justify-center shadow-lg border-2 transition-all active:scale-90 ${
                    isPlaying 
